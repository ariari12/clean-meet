...
export default function Home() {
  return (
    <Layout>
      <div className="pt-[72px] flex flex-col items-center space-y-16">
        {/* 플랫폼 짧은 슬로건 & 메인 이미지 영역*/}
        <section className="relative w-full h-[500px] flex flex-col justify-center items-center text-center bg-gray-900 text-white">
          <Image
        ...
        <section className="max-w-4xl text-center space-y-8">
          <h2 className="text-3xl font-semibold">전문가의 도움이 필요한 혼자 청소하기 힘든 순간들</h2>
